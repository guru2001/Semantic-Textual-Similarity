...
df_train = pd.read_csv('../data/Quora/train.tsv', names = ['Label', 'Q1', 'Q2', 'Id'], sep = "\t", encoding='latin-1', skip_blank_lines=True)


# In[10]:


df_dev = pd.read_csv('../data/Quora/dev.tsv', names = ['Label', 'Q1', 'Q2', 'Id'], sep = "\t", encoding='latin-1', skip_blank_lines=True)


# In[11]:


df_test = pd.read_csv('../data/Quora/test.tsv', names = ['Label', 'Q1', 'Q2', 'Id'], sep = "\t", encoding='latin-1', skip_blank_lines=True)
...
#model = LNetForSequenceClassification.from_pretrained("xlnet-base-cased", num_labels=2)
